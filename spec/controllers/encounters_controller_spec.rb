  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Encounter" do
        expect {
          post :create, :encounter => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested encounter" do
        ...
        Encounter.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => encounter.id, :encounter => {'these' => 'params'}
      end

      it "assigns the requested encounter as @encounter" do
        encounter = Encounter.create! valid_attributes
        put :update, :id => encounter.id, :encounter => valid_attributes
        assigns(:encounter).should eq(encounter)
      end
