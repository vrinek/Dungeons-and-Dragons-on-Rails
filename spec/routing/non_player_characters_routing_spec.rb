...
describe NonPlayerCharactersController do
  describe "routing" do
    ...
    it "routes to #index" do
      get("/non_player_characters").should route_to("non_player_characters#index")
    end
    ...
    it "routes to #destroy" do
      delete("/non_player_characters/1").should route_to("non_player_characters#destroy", :id => "1")
    end
